...
export const metadata: Metadata = {
  ...
  title: 'PvP DPS Calculator - OSRS Wiki',
  description: "Compare Old School RuneScape PvP loadouts using a fork of the OSRS Wiki's damage-per-second calculator.",
  authors: [{ name: 'OSRS Wiki', url: 'https://oldschool.runescape.wiki' }],
  keywords: ['osrs', 'old school runescape', 'runescape', 'pvp dps calculator', 'osrs pvp dps', 'osrs wiki', 'osrs wiki dps'],

...
export const SOULREAPER_MAX_STACKS = 5;
export const SOULREAPER_STACK_DAMAGE_BONUS_PERCENT = 6;
export const SOULREAPER_SPEC_ACCURACY_BONUS_PERCENT = 12;
export const SOULREAPER_SPEC_MIN_HIT_PERCENT = 6;
